DROP INDEX IF EXISTS `ralph_prds_chat_id_idx`;--> statement-breakpoint
DROP TABLE IF EXISTS `ralph_progress`;--> statement-breakpoint
DROP TABLE IF EXISTS `ralph_prds`;--> statement-breakpoint
...
CREATE INDEX `ralph_prds_sub_chat_id_idx` ON `ralph_prds` (`sub_chat_id`);--> statement-breakpoint
