...
>(({ className, children, showCloseButton = false, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 w-[420px] max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] rounded-xs bg-tl-background border border-border shadow-2xl overflow-hidden ring-4 ring-neutral-200/50 dark:ring-neutral-800/50",
