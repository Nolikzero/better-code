...
>(({ className, children, showCloseButton = true, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      data-canvas-dialog
      className={cn(
        "fixed left-[50%] top-[50%] z-50 w-[420px] max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] rounded-sm bg-tl-background border border-border shadow-2xl overflow-hidden",
...
const CanvasDialogFooter = ({
  ...
  <div
    className={cn(
      "bg-muted p-4 flex justify-end gap-2 border-t border-border rounded-b-sm",
      className,
    )}
    {...props}
  />
